/**
 * @name Core.directives:brightcove
 * @restrict EA
 *
 * @description
 * Creates a Brightcove video player
 *
 * @param {string}     id - Brightcove Video ID
 * @param {string}     playlist-id - Brightcove Playlist ID
 * @param {string}     video-still - Video Still URL
 */
